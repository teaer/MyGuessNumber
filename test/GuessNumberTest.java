...
public class GuessNumberTest {
    ...
    public void should_return_2a0b_given_two_numbers_are_correct(){
        GuessNumber guessNumber = new GuessNumber("1234") ;
                String result =guessNumber.validate("1255")  ;
        assertEquals("2a0b",result );
    }
    @Test
    public void should_return_2a1b_given_two_numbers_are_correct_and_one_number_direction_is_wrong(){
        GuessNumber guessNumber=new GuessNumber("1234") ;
        String result = guessNumber.validate("1248") ;
